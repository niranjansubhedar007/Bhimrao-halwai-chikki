...
// //     <>
// //       <MainNavbar />
// //       <section className="text-gray-600 body-font bg-white mt-7 font text-xs lg:text-base md:text-md">
...
// //                       src="./images/veg.png"
// //                       alt="Veg Icon"
// //                         className="lg:w-8 lg:h-8 md:w-6 md:h-6 w-5 h-5 absolute  lg:right-2 md:right-1 right-1
// //                        lg:top-2 md:top-1 top-1"
// //                     />
...
// //                         onClick={() => handleIconClick(product, "small")}
// //                       />
...
// //                         {product.smallSizeName} (20g)
// //                       </h2>
// //                     </div>
// //                   </div>
// //                   <div className="justify-center flex">
// //                     <p className="mt-1 ml-2 font-medium text-md">
// //                       Rs. {product.smallSizeRs}.00
// //                     </p>
// //                   </div>
// //                   <div className="justify-center flex mt-1">
// //                     <Link href={`/cart?size=small&id=${product._id}`}>
...
// //                         icon={faEye}
// //                         className="lg:w-5 lg:h-5 md:w-4 md:h-4 w-4 h-4 absolute bottom-2 right-2 cursor-pointer"
// //                         onClick={() => handleIconClick(product, "medium")}
// //                       />
// //                       <div className="absolute bottom-8 right-2 bg-black text-white text-xs rounded p-1 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
// //                         Quick View
// //                       </div>
...
// //                     <div className="flex">
// //                       <h2 className="text-gray-900 title-font lg:text-lg text-sm font-semibold flex text-center justify-center">
// //                         {product.mediumSizeName} (125g)
// //                       </h2>
// //                     </div>
// //                   </div>
// //                   <div className="justify-center flex">
// //                     <p className="mt-1 ml-2 font-medium text-md">
// //                       Rs. {product.mediumSizeRs}.00
// //                     </p>
// //                   </div>
// //                   <div className="justify-center flex mt-1">
// //                     <Link href={`/cart?size=medium&id=${product._id}`}>
// //                       <button className="bg-orange-700 text-white hover:bg-orange-800 mt-1 rounded-full items-center px-5 py-2 text-center cursor-pointer">
// //                         Order Now
// //                       </button>
// //                     </Link>
...
// //                         onClick={() => handleIconClick(product, "large")}
// //                       />
// //                       <div className="absolute bottom-8 right-2 bg-black text-white text-xs rounded p-1 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
// //                         Quick View
// //                       </div>
...
// //                     <div className="flex">
// //                       <h2 className="text-gray-900 title-font lg:text-lg text-sm font-semibold flex text-center justify-center">
// //                         {product.largeSizeName} (250g)
// //                       </h2>
// //                     </div>
// //                   </div>
// //                   <div className="justify-center flex">
// //                     <p className="mt-1 ml-2 font-medium text-md">
// //                       Rs. {product.largeSizeRs}.00
// //                     </p>
// //                   </div>
// //                   <div className="justify-center flex mt-1">
// //                     <Link href={`/cart?size=large&id=${product._id}`}>
// //                       <button className="bg-orange-700 text-white hover:bg-orange-800 mt-1 rounded-full items-center px-5 py-2 text-center cursor-pointer">
// //                         Order Now
// //                       </button>
// //                     </Link>
...
// //           <div className="bg-white  lg:p-8 md:p-2 m-1 p-2  rounded shadow-lg flex flex-col lg:flex-row">
...
// //                 {selectedSize === "small" &&
// //                   popupContent.smallSizeName}
// //                 {selectedSize === "medium" &&
// //                   popupContent.mediumSizeName }
// //                 {selectedSize === "large" &&
// //                   popupContent.largeSizeName }
// //               </h2>
// //               <p className="text-gray-600 lg:mb-4 md:mb-1 mb-1">{popupContent.description}</p>
...
// //                   </tr>
// //                   <tr>
// //                     <td className="border-b py-2 px-2">Calorific Value Kcal/100g</td>
...
//   const renderProductSize = (product, size, sizeName, sizeWeight, sizePrice) => (
//     <div
...
const Order = () => {
  ...
  useEffect(() => {
    const fetchProducts = async () => {
      try {
        const response = await fetch("https://bhimrao-halwai-chikki-backend.vercel.app/productData"); // Update the endpoint if needed
        const data = await response.json();
        console.log("Fetched products:", data); // Log fetched products
        setProducts(data);
      } catch (error) {
